...
Node.js version 6 is deprecated as of 6 December 2018 ([see Node.js release schedule](https://github.com/nodejs/Release)).
...
To continue using a JavaScript action, update to Node.js version 8 or 10.
{: deprecated}
