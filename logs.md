...
4. Optional: To see older logs, change the default timeframe value of 15 minutes by clicking **Last 15 minutes** and selecting a different timeframe.
...
* Find all failed activations.
    ...
    ```
    {: codeblock}
    In the results, a `0` indicates that an action successfully exited. All other values indicate an error.
