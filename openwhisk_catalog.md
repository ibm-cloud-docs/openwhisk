...
The catalog is available as packages in the `/whisk.system` and `/watson-iot` namespaces. For more information, see [Browse packages](openwhisk_packages.html#browse-packages).
