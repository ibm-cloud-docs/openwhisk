...
The catalog is available as packages in the `/whisk.system` and `/watson-iot` namespaces. For more information, see [Browsing packages](./openwhisk_packages.md#browsing-packages).
