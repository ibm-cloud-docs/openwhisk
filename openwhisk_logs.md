...
You can find specific activation logs in [{{site.data.keyword.loganalysislong_notm}}](/docs/services/CloudLogAnalysis/kibana/analyzing_logs_Kibana.html#analyzing_logs_Kibana) by using Kibana's query syntax.
