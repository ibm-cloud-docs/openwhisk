...
: Yes! With replication, you can define rules for automatically copying bucket objects from a source bucket to one or more destination buckets. For more information, see [Replication overview](/docs/cloud-object-storage?topic=cloud-object-storage-replication-overview).
