...
[Getting started with IBM {{site.data.keyword.openwhisk_short}}](/docs/openwhisk?topic=openwhisk-getting-started#getting-started)
...
[Common use cases](/docs/openwhisk?topic=openwhisk-use_cases#use_cases)
...
[How {{site.data.keyword.openwhisk_short}} works](/docs/openwhisk?topic=openwhisk-about#about)
...
[Function as a Service architecture](/docs/openwhisk?topic=openwhisk-faas#faas)
...
[Calling an action from another action](/docs/openwhisk?topic=openwhisk-tutorial_action#tutorial_action)
...
* [June 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jun21)
    ...
    * [21 June 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jun2121)

        * Overview topic for troubleshooting

* [May 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-may21)

    * [7 May 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-may721)

        * Deprecated of packages and runtimes.

    * [1 May 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-may0121)

        * Added information about error handling.

        * Added information about getting support. 

* [April 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-apr21)

    * [27 April 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-apr0721)
...
* [March 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-mar21)

    * [29 March 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-march2921)

        * New Functions CLI version 1.0.53.

    * [25 March 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-mar2521)
    ...
    * [12 March 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-mar1221)

        * Added support for `au-syd` (Sydney) region.

* [January 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jan21)

    * [29 January 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jan2921)

        * Added a sitemap.

        * Updated information about packaging Go source files. 

* [December 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-dec20)
...
* [October 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-oct20)

    * [29 October 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-oct2920)

        * GO 1.15 is now supported.

* [September 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-sep20)

    * [22 September 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-sep2220)
...
* [August 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-aug20)

    * [25 August 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-aug2520)

        * New troubleshooting information.

* [July 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jul20)

    * [30 July 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jul3020)

        * Updated information for High availability and disaster recovery.

    * [23 July 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jul2320)

        * New information for actions that use binary files.

    * [16 July 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jul1620)

        * New Functions CLI version 1.0.44 release.

    * [10 July 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jul1020)

        * New Functions CLI version 1.0.43.

        * Additional events and information are available for Functions. 

* [June 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jun20)

    * [30 June 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jun3020)

        * Updates to documentation for Event streams package.

    * [25 June 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jun2520)

        * New events are tracked for Functions.

    * [18 June 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jun1820)

        * Changes for web action endpoints.

    * [15 June 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jun1520)

        * New Functions CLI version 1.0.41.

    * [8 June 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-jun820)
...
* [May 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-may20)

    * [22 May 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-may2220)

        * New tutorial for calling an action from another action.

    * [15 May 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-may1520)

        * New High availability topic.

        * Updates for supported runtimes.

* [April 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-apr20)

    * [24 April 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-apr2420)
...
* [March 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-mar20)

    * [24 March 2021](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-mar2420)

        * Node.js 8 is deprecated.

    * [9 March 2020](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-mar920)
...
* [December 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-dec19)

    * [18 December 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-dec1819)
...
* [November 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-nov19)

    * [18 November 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-nov1819)

        * New Functions CLI version 1.0.36. 

* [October 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-oct19)

    * [31 October 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-oct3119)
    ...
    * [28 October 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-oct2819)

        * Updates for binding services to entities.

        * Updates for memory usage.

    * [14 October 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-oct1419)

        * New Functions CLI version 1.0.35. 

        * Added console tasks to actions. 

* [September 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-sep19)

    * [24 September 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-sep2419)

        * New Functions CLI version 1.0.34. 

    * [20 September 2019](/docs/openwhisk?topic=openwhisk-openwhisk-relnotes#openwhisk-sep2019)
...
[Installing the CLI and plug-in](/docs/openwhisk?topic=openwhisk-cli_install#cli_install)
...
[Managing namespaces](/docs/openwhisk?topic=openwhisk-namespaces#namespaces)
...
* [Creating an IAM-based namespace](/docs/openwhisk?topic=openwhisk-namespaces#create_iam_namespace)
    ...
    * [Optional workflow: Creating namespaces for staging and production deployments](/docs/openwhisk?topic=openwhisk-namespaces#namespaces_create_stage_prod)
...
[Action overview](/docs/openwhisk?topic=openwhisk-actions_over#actions_over)

[Planning serverless apps](/docs/openwhisk?topic=openwhisk-plan#plan)
...
[Creating actions](/docs/openwhisk?topic=openwhisk-actions#actions)
...
* [Versioning your actions](/docs/openwhisk?topic=openwhisk-actions#actions-version)
    ...
    * [Version control systems](/docs/openwhisk?topic=openwhisk-actions#actions-version-control)

    * [Naming conventions](/docs/openwhisk?topic=openwhisk-actions#actions-naming-conventions)

[Creating web actions](/docs/openwhisk?topic=openwhisk-actions_web#actions_web)
...
* [Web action limits](/docs/openwhisk?topic=openwhisk-actions_web#actions_web_limits)

[Creating sequences](/docs/openwhisk?topic=openwhisk-sequences#sequences)
...
[Preparing apps for actions](/docs/openwhisk?topic=openwhisk-prep#prep)
...
* [Preparing PHP apps](/docs/openwhisk?topic=openwhisk-prep#prep_php)
    ...
    * [Packaging Composer modules](/docs/openwhisk?topic=openwhisk-prep#prep_php_composer)
...
[Creating triggers for events](/docs/openwhisk?topic=openwhisk-triggers#triggers)
...
[Associating triggers and actions through rules](/docs/openwhisk?topic=openwhisk-rules#rules)
...
[Testing serverless apps](/docs/openwhisk?topic=openwhisk-test#test)
...
[Setting access policies](/docs/openwhisk?topic=openwhisk-iam#iam)
...
[Binding {{site.data.keyword.cloud_notm}} services to {{site.data.keyword.openwhisk_short}} entities](/docs/openwhisk?topic=openwhisk-services#services)
...
[Incorporating packages](/docs/openwhisk?topic=openwhisk-pkg_ov#pkg_ov)
...
[Alarms](/docs/openwhisk?topic=openwhisk-pkg_alarms#pkg_alarms)
...
[Cloudant](/docs/openwhisk?topic=openwhisk-pkg_cloudant#pkg_cloudant)
...
[Composer](/docs/openwhisk?topic=openwhisk-pkg_composer#pkg_composer)

* [Installing the Composer library for JavaScript or Python](/docs/openwhisk?topic=openwhisk-pkg_composer#install_composer)

    * [For JavaScript](/docs/openwhisk?topic=openwhisk-pkg_composer#install_composer_js)

    * [For Python](/docs/openwhisk?topic=openwhisk-pkg_composer#install_composer_python)
...
[{{site.data.keyword.messagehub}}](/docs/openwhisk?topic=openwhisk-pkg_event_streams#pkg_event_streams)
...
[Mobile SDK](/docs/openwhisk?topic=openwhisk-pkg_mobile_sdk#pkg_mobile_sdk)
...
[Object Storage](/docs/openwhisk?topic=openwhisk-pkg_obstorage#pkg_obstorage)
...
* [Setting up the {{site.data.keyword.cos_full_notm}} trigger](/docs/openwhisk?topic=openwhisk-pkg_obstorage#pkg_obstorage_ev)
    ...
    * [3. Creating a trigger to listen for bucket changes](/docs/openwhisk?topic=openwhisk-pkg_obstorage#pkg_obstorage_ev_trig)
...
* [Writing an object to a bucket](/docs/openwhisk?topic=openwhisk-pkg_obstorage#pkg_obstorage_write)
    ...
    * [Writing an object to a bucket with the console](/docs/openwhisk?topic=openwhisk-pkg_obstorage#pkg_obstorage_write_ui)

    * [Writing an object to a bucket with the CLI](/docs/openwhisk?topic=openwhisk-pkg_obstorage#pkg_obstorage_write_cli)

* [Reading objects from a bucket](/docs/openwhisk?topic=openwhisk-pkg_obstorage#pkg_obstorage_read)

    * [Reading an object with the console](/docs/openwhisk?topic=openwhisk-pkg_obstorage#pkg_obstorage_read_ui)

    * [Reading an object with the CLI](/docs/openwhisk?topic=openwhisk-pkg_obstorage#pkg_obstorage_read_cli)
...
[Slack](/docs/openwhisk?topic=openwhisk-pkg_slack#pkg_slack)

* [Posting a message to a Slack channel](/docs/openwhisk?topic=openwhisk-pkg_slack#pkg_slack_post)

* [Using the Slack token-based API](/docs/openwhisk?topic=openwhisk-pkg_slack#pkg_slack_api)

[Utilities](/docs/openwhisk?topic=openwhisk-pkg_utils#pkg_utils)

[WebSocket](/docs/openwhisk?topic=openwhisk-pkg_websocket#pkg_websocket)

* [Send a message to a WebSocket](/docs/openwhisk?topic=openwhisk-pkg_websocket#send-websocket)

[Creating custom event provider feeds](/docs/openwhisk?topic=openwhisk-feeds_custom#feeds_custom)
...
[{{site.data.keyword.mon_full_notm}}](/docs/openwhisk?topic=openwhisk-alerts-notify#alerts-notify)


### Watson packages
{: #sitemap_watson_packages}


[{{site.data.keyword.conversationshort}}](/docs/openwhisk?topic=openwhisk-pkg_watson_assistant#pkg_watson_assistant)
...
[{{site.data.keyword.nlclassifiershort}}](/docs/openwhisk?topic=openwhisk-pkg_natlang_classifier#pkg_natlang_classifier)
...
[{{site.data.keyword.nlushort}}](/docs/openwhisk?topic=openwhisk-pkg_natlang_understanding#pkg_natlang_understanding)
...
[{{site.data.keyword.toneanalyzershort}}](/docs/openwhisk?topic=openwhisk-pkg_tone_analyzer#pkg_tone_analyzer)
...
[{{site.data.keyword.languagetranslatorshort}}](/docs/openwhisk?topic=openwhisk-pkg_translator#pkg_translator)
...
[{{site.data.keyword.speechtotextshort}}](/docs/openwhisk?topic=openwhisk-pkg_speech_to_text#pkg_speech_to_text)
...
[{{site.data.keyword.texttospeechshort}}](/docs/openwhisk?topic=openwhisk-pkg_text_to_speech#pkg_text_to_speech)
...
[{{site.data.keyword.discoveryshort}}](/docs/openwhisk?topic=openwhisk-pkg_discovery#pkg_discovery)
...
[Deploying entities with a manifest file](/docs/openwhisk?topic=openwhisk-deploy#deploy)

* [Creating the Hello World API example](/docs/openwhisk?topic=openwhisk-deploy#deploy_helloworld_example)

* [More OpenWhisk deployment examples](/docs/openwhisk?topic=openwhisk-deploy#more_deploy_examples)

* [Deployment manifest specification](/docs/openwhisk?topic=openwhisk-deploy#manifest_specification)
...
[Viewing logs](/docs/openwhisk?topic=openwhisk-logs#logs)
...
[Auditing events for {{site.data.keyword.openwhisk_short}}](/docs/openwhisk?topic=openwhisk-at_events#at_events)
...
[Monitoring {{site.data.keyword.openwhisk_short}} entities with {{site.data.keyword.mon_full_notm}}](/docs/openwhisk?topic=openwhisk-monitor-functions#monitor-functions)
...
[Annotations](/docs/openwhisk?topic=openwhisk-annotations#annotations)
...
[Runtimes](/docs/openwhisk?topic=openwhisk-runtimes#runtimes)
...
* [Ruby runtime](/docs/openwhisk?topic=openwhisk-runtimes#openwhisk_ref_ruby)
...
[System details and limits](/docs/openwhisk?topic=openwhisk-limits#limits)
...
[Error handing for {{site.data.keyword.openwhisk_short}}](/docs/openwhisk?topic=openwhisk-error-handing-functions#error-handing-functions)
...
[Regions](/docs/openwhisk?topic=openwhisk-cloudfunctions_regions#cloudfunctions_regions)
...
[Understanding high availability and disaster recovery for {{site.data.keyword.openwhisk_short}}](/docs/openwhisk?topic=openwhisk-ha_dr#ha_dr)
...
[API reference](https://cloud.ibm.com/apidocs/functions){: external}
...
[Discover: IBM Cloud Functions](https://www.ibm.com/cloud/functions){: external}

[Pricing](https://cloud.ibm.com/functions/learn/pricing){: external}

[Apache OpenWhisk](http://openwhisk.apache.org/){: external}

[Tutorials and samples](https://github.com/apache/openwhisk-external-resources){: external}
...
[FAQ](/docs/openwhisk?topic=openwhisk-faq#faq)
...
[Troubleshooting overview](/docs/openwhisk?topic=openwhisk-troubleshooting#troubleshooting)
...
[Action is failing](/docs/openwhisk?topic=openwhisk-ts_action_fails#ts_action_fails)

[Service configuration properties are incorrect](/docs/openwhisk?topic=openwhisk-ts_property#ts_property)
...
{: #sitemap_nodejs_troubleshooting}
