...
* [API commands](/docs/openwhisk?topic=openwhisk-functions-cli#cli_api)

    * [`ibmcloud fn api create`](/docs/openwhisk?topic=openwhisk-functions-cli#cli_api_create)

    * [`ibmcloud fn api delete`](/docs/openwhisk?topic=openwhisk-functions-cli#cli_api_delete)

    * [`ibmcloud fn api get`](/docs/openwhisk?topic=openwhisk-functions-cli#cli_api_get)

    * [`ibmcloud fn api list`](/docs/openwhisk?topic=openwhisk-functions-cli#cli_api_list)
