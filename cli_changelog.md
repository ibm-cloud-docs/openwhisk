...
| 1.0.30 | 03 April 2019 | <ul><li>Improved the **`service bind`** command handling of IAM and org and space-based services.</li><li>Added a fix for handling API endpoint `https://cloud.ibm.com`.</li></ul> |
