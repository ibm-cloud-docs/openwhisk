...
문제를 해결하고 액션의 상태와 성능을 개선하는데 도움이 될 수 있도록 로깅 및 모니터링은 {{site.data.keyword.openwhisk}}에서 자동으로 사용됩니다. 또한 {{site.data.keyword.cloudaccesstraillong}} 서비스를 사용하여 사용자와 애플리케이션이 {{site.data.keyword.openwhisk_short}} 서비스와 상호작용하는 방법을 추적할 수 있습니다.
