...
`demo`.
        ...
        ```
        {: pre}
4.  Ejecute la composición de la misma manera que [invoca otras acciones](/docs/openwhisk?topic=cloud-functions-openwhisk_triggers#openwhisk_triggers) en {{site.data.keyword.openwhisk}}.
    ```
