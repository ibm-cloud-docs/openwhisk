...
Si no detecta nuevas activaciones, consulte el tema [{{site.data.keyword.cloudant_short_notm}}](/docs/openwhisk?topic=cloud-functions-cloudant_actions) que muestra cómo leer y escribir en una base de datos {{site.data.keyword.cloudant_short_notm}}. Pruebe los siguientes pasos de lectura y escritura para ayudar a comprobar si sus credenciales de {{site.data.keyword.cloudant_short_notm}} son correctas.
{: tip}
