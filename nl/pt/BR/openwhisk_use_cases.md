...
[Emoting](https://github.com/l2fprod/openwhisk-emoting) é um aplicativo de amostra que usa ações do {{site.data.keyword.openwhisk_short}} por meio de uma API de REST.
