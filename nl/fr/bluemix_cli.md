...
Utilisez la commande `ibmcloud target` pour changer les régions. Par exemple, si vous souhaitez passer dans la région United Kingdom et dans l'espace `staging` :
```
