...
* Pour plus d'informations sur la signification des modèles que le service utilise pour décrire les caractéristiques de personnalité, consultez la rubrique relative aux [modèles de personnalité](https://cloud.ibm.com/docs/services/personality-insights/models.html).
* Pour plus d'informations sur la signification des préférences de consommation, consultez la rubrique relative aux [préférences de consommation](https://cloud.ibm.com/docs/services/personality-insights/preferences.html).
