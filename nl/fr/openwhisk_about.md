...
Tout d'abord, créez un fichier *action.js* contenant le code suivant qui imprime "Hello World" dans la sortie standard et renvoie un objet JSON incluant "world" sous la clé "hello".
```javascript
function main() {
